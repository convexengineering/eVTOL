...
configurations["Multirotor"]["Cl_{mean_{max}}"] = 0.6
...
configurations["Autogyro"]["Cl_{mean_{max}}"] = 0.8
...
configurations["Helicopter"]["Cl_{mean_{max}}"] = 0.6
...
configurations["Tilt rotor"]["Cl_{mean_{max}}"] = 1.0